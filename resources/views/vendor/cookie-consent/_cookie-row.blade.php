...
<div class="cookie-consent-cookie-item {{ $cookieModel->isGroup ? 'cookie-consent-cookie-group' : '' }}">
    <div class="cookie-consent-cookie-item-title">{{ __("frontend.$projectPath.cookie-consent.cookies." . $cookieModel->titleKey) }}</div>
    <div class="cookie-consent-cookie-item-detail">
        <div class="cookie-consent-cookie-item-description">{{ __("frontend.$projectPath.cookie-consent.cookies." . $cookieModel->descriptionKey) }}</div>
